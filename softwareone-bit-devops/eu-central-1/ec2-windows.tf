...
module "detvs01229" {
  ...
  vpc_id                   = "vpc-02d82d26468e360b4"
  nic_subnet_locator       = "Infrastructure"
  nic_private_ip_addresses = [ "10.99.23.82" ]
  security_group_scenario  = "Jenkins"
  security_group_suffix    = [ "" ]
  monitoring               =  
  ssm_document_domainjoin  = "SWO-BCWindowsADJoin-domain-global-d-996728e3d6"
...
module "detvs01230" {
  ...
  vpc_id                   = "vpc-02d82d26468e360b4"
  nic_subnet_locator       = "Infrastructure"
  nic_private_ip_addresses = [ "10.99.23.83" ]
  security_group_scenario  = "Jenkins"
  security_group_suffix    = [ "" ]
  monitoring               =  
  ssm_document_domainjoin  = "SWO-BCWindowsADJoin-domain-global-d-996728e3d6"
...
module "detvs01231" {
  ...
  vpc_id                   = "vpc-02d82d26468e360b4"
  nic_subnet_locator       = "Infrastructure"
  nic_private_ip_addresses = [ "10.99.23.84" ]
  security_group_scenario  = "Jenkins"
  security_group_suffix    = [ "" ]
  monitoring               =  
  ssm_document_domainjoin  = "SWO-BCWindowsADJoin-domain-global-d-996728e3d6"
...
module "detvs01234" {
  ...
  vpc_id                   = "vpc-02d82d26468e360b4"
  nic_subnet_locator       = "Infrastructure"
  nic_private_ip_addresses = [ "10.99.23.87" ]
  security_group_scenario  = "Jenkins"
